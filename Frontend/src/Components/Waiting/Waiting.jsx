...
export  default  function Waiting(){
    ...
    */
    //开放滚动
    function startwheel() {
        document.querySelector("#waiting-cover").removeEventListener('DOMMouseScroll', stopScroll, false);
    ...
    function stopwheel() {
        ...
        if (str.indexOf('firefox') !== -1) { //火狐浏览器
            document.querySelector("#waiting-cover").addEventListener('DOMMouseScroll', stopScroll, false);
        } else { //非火狐浏览器
            document.querySelector("#waiting-cover").onmousewheel = stopScroll;
        }
    }
